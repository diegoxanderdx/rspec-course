los compound expectations nos sirve para hacer varias expectativas en una sola linea de codigo, esto se logra con and.
...
RSpec.describe [:usa, :canada, :mexico] do
  # con or podemos hacer que una expectativa sea verdadera si una de las condiciones es verdadera.
